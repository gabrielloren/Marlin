...
#define STRING_CONFIG_H_AUTHOR "Gabriel Lorenzetti, SKR-mini-E3-V3.0" // Who made the changes.
...
#define DIAG_JUMPERS_REMOVED // Comment out to use the diag pin jumpers on the board
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -12, 33, -0.10 }
